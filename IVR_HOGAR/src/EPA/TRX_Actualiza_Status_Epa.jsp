...
public JSONObject performLogic(JSONObject state, Map<String, String> additionalParams) throws Exception {
	...
	String nameJSP="TRX_Actualiza_Status_Epa";
    ...
    try{
    	...
    	fEPCS.Debug("["+nameJSP+"] StatusID : "+StatusID, "INFO");
    	fEPCS.Debug("["+nameJSP+"] Tramo : "+Tramo, "INFO");

    	
    	parametros_marcas_navegacion=fEPCS.startNavegacion(state,"TRX_ACTUALIZA_STATUS_EPA");
		...
		String respuestaDB= fEPCS.Socket_SendRecvHA("ACTUALIZA_STATUS_EPA", DataEnvioSckt.toString(),"DB2");
		...
		if(!respuestaDB.equals("[]")||respuestaDB.indexOf("errorMessage")==-1){
			...
			if(RC.equals("0")){
				...
				parametros_marcas_navegacion.put("MSG",StatusID);
				fEPCS.Debug("["+nameJSP+"] Actualizacion de Status: ", "INFO");	
			}
			jObjRespuesta = null;
		}	
    }catch(Exception ex){
